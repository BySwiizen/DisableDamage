...
tasks {
    ...
    shadowJar {
        ...
        relocate("org.jetbrains.annotations", "fr.byswiizen.disabledamage.libs.annotations")
        relocate("com.google.gson", "fr.byswiizen.disabledamage.libs.gson")
        relocate("org.apache.commons", "fr.byswiizen.disabledamage.libs.commonslang3")
        relocate("com.tcoded.folialib", "fr.byswiizen.disabledamage.libs.folialib")
        relocate("dev.dejvokep.boostedyaml", "fr.byswiizen.disabledamage.libs.boostedyaml")
        relocate("org.bstats", "fr.byswiizen.disabledamage.libs.metrics")
